...
$sql="select * from fotos,album where idalbum=;$idalbum and iddalbum.albumes";
    ...
    <div>
      <nav class="fixed-top" >
       ...
       <td ><button class="btn btn-primary btn-lg"type="submit" value="agregar"  formaction="procesos/proceso_cargar_fotos.php?idalbum=<?php echo $idalbum?>">Cargar Fotos</button></td>
		  ...
		  <div class="col-md-7">
			<h3><label>Título del del Álbum:</label><?php  echo utf8_encode($titulo) ?></h3>
<h4><label>Descripción:</label><?php  echo utf8_encode($descripcion) ?></h4>
		  </div>
