...
$xajax->registerFunction('guardarcalificacion');
...
foreach($arrresultado as $i=>$valor){
    ...
    $titulopagina = "Calificar - ".$compania_nombre;
    $descripcionpagina = "Calificar - $compania_nombre ";
...
$arrresultado = $conexion->doSelect("
  ...
  ",
  "solicitudserv_activo = '1' and solicitudservicio.solicitudserv_id = '$getsolicitudserv_id' and solicitudservicioprestador.usuario_id = '$getusuario_id'  ", null, "solicitudservicio.solicitudserv_id desc"); 
            ...
            <div class="row">
                ...
                <div class="col-md-10 offset-md-1 col-lg-9 offset-lg-0 order-sm-2 order-1">
                    ...
                    <div class="widget welcome-message" style="padding-bottom: 10px">
                        <h2 style="font-size: 20px"><i class="fa fa-star"></i> Calificar a <?php echo $usuarioprestador;?> por el siguiente servicio:</h2>                        
                    </div>

                    <form action="javascript:guardarcalificacion()">                      
                      <div class="row" style="margin-top: 15px">
                        ...
                        <div class="col-md-8 col-8" style="text-align: left;">
                          ...
                          <br />
                          <input type='hidden' name='rating' value='5' id='star1_input' />
                        </div>                      
                      </div>
                      <div class="row" style="margin-top: 15px">
                        <div class="col-md-4 col-4" style="text-align: right; font-weight: 700">
                      ...
                      <div class="row" style="margin-top: 15px">
                        ...
                        <div class="col-md-8 col-8" style="text-align: left">
                          ...
                          <br />
                          <input type='hidden' name='rating' value='5' id='star3_input' />
                        </div>                      
                      </div>
                      <div class="row" style="margin-top: 15px">
                        <div class="col-md-4 col-4" style="text-align: right; font-weight: 700">
                        ...
                        <div class="col-md-8 col-8" style="text-align: left">
                          <textarea class="form-control" id="comentarios" required="required" style="width: 100%"></textarea>
                        </div>                      
                      </div>
                      <div class="row" style="margin-top: 15px">
                        <div class="col-md-4 col-4" style="text-align: right; font-weight: 700">
                        ...
                        <div class="col-md-8 col-8" style="text-align: left">
                          <input type="submit" name="submit" value="Guardar Calificación" class="btn btn-primary">
