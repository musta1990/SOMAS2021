...
if ($getcateg!=""){
    $___old_wherecateg = " and preguntafrecuentecategoria.categ_id = '$getcateg'";
}
...
foreach($arrresultado as $i=>$valor){
    ...
    $titulopagina = "Preguntas Frecuentes - ".$compania_nombre;
    $descripcionpagina = "Preguntas Frecuentes - $compania_nombre. Te ayudamos a resolver las dudas que tengas en la plataforma mostrandote las preguntas frecuentes que mas recibimos ";
...
<body class="body-wrapper">
    ...
    <?php include_once "include-preguntas-frecuentes.php"; ?>
...
<script src="plugins/jQuery/jquery.min.js"></script>
  ...
  <script src="../../more/js/jquery-2.1.1.js"></script>
