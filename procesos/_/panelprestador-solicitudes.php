...
$arrresultado = $conexion->doSelect("
  ...
  solicitudservicioprestador.usuario_id, solicitudservicioprestador.l_estatus_id as estatus_idservicioprestador, 
  ...
  "solicitudservicio
    ...
    inner join usuarioservicio on usuarioservicio.l_categservicio_id = categoria.lista_id
               ...
               and usuarioservicio.usuario_id = '$iniuser' and usuarioservicio_activo = '1'
  ...
  ",
  "solicitudserv_activo = '1'  and solicitudservicio.cuenta_id = '$SistemaCuentaId' and solicitudservicio.compania_id = '$SistemaCompaniaId' ", null, "solicitudservicio.solicitudserv_id desc"); 
...
foreach($arrresultado as $i=>$valor){
  ...
  if ($solicitudservpresta_id==""){
    $estatusservicioprestador_nombre = "No Leído";
    $chatcliente = "";
  }else{
    $chatcliente = "
  ...
  if ($estatusservicioprestador_cod=="3" || $estatusservicioprestador_cod=="4" || $estatusservicioprestador_cod=="5" ){
    // Se deja el chat
  }else{
    $chatcliente ="";
  }
  ...
  if ($estatusservicioprestador_cod=="6" ){
    $chatcliente = "";
  }
  ...
  $textosolicitudes .= "
    <tr style='font-size: 14px; text-align: center'>
        ...
        <td>$solicitudserv_infodir</td>            
        <td>$estatusservicioprestador_nombre $chatcliente</td> 
    </tr>
    ";
...
if ($textosolicitudes==""){
    ...
    <tr style='font-size: 14px'>
        <td colspan='6' style='text-align: center'>
            <a href='panelprestador-servicios'>
                No existen solicitudes recibidas para su perfil, revisa tus Servicios que ofreces aquí
            </a>
        </td>        
    </tr>
	    ";
                ...
                <div class="col-md-10 offset-md-1 col-lg-9 offset-lg-0 order-sm-2 order-1">
                  <?php include_once "panel-notificaciones.php"; ?>
                    ...
                    <div class="widget welcome-message" style="padding-bottom: 10px">
                        <h2><i class="fa fa-paper-plane"></i> Solicitudes por Portal</h2>
                        <p>Puedes observar todas las solicitudes enviadas por el cliente que coincidan con tus servicios</p>
                    </div>
