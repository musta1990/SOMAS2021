...
foreach($arrresultado as $i=>$valor){
    ...
    $titulopagina = "Desuscribir - ".$compania_nombre;
    $descripcionpagina = "Desuscribir - $compania_nombre. Podrás desuscribirte cuando desees de nuestras notificaciones solo colocando tu email ";
...
if ($email!=""){
  ...
  $arrresultado = $conexion->doSelect("usuario_id",
    "usuario", 
    " usuario_email = '$email' and usuario_activo = '1' and usuario.cuenta_id = '$SistemaCuentaId' and usuario.compania_id = '$SistemaCompaniaId'");
  ...
  if (count($arrresultado)>0){
      ...
      foreach($arrresultado as $m=>$valor){
        ...
        header("Location: desuscripcion.php?email=$email");
    ...
    $info = "
        <div class='alert alert-danger' style='text-align: center; font-weight: normal;'>
            <a style='color: #000; font-size: 14px; text-decoration: none;'>
                <strong>Error:</strong> el Email <strong>$email</strong> no se encuentra registrado en nuestro sistema<br> por favor verifique o contactese con nosotros al email $compania_email
            </a><br>
        </div>
      ";
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-8 align-item-center">
                <div class="border">
                    <h3 class="bg-gray p-4" style="text-align: center">Desuscribir</h3>
                    <form action="desuscribir" >
                        <fieldset class="p-4">
                            <input type="email" placeholder="Email *" id="email" name="email" required="required" class="border p-3 w-100 my-2" />
                          
                            <br />
                            <center>
                                <button type="submit" class="d-block py-3 px-5 bg-primary text-white border-0 rounded font-weight-bold mt-3">Confirmar</button>
                            </center>                            
                        </fieldset>
                    </form>
                </div>
