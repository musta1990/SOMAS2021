...
$UrlFiles = UrlFiles;
$Seccion_Terminos = Seccion_Terminos;
...
foreach($arrresultado as $i=>$valor){
    ...
    $titulopagina = "Terminos y Condiciones - ".$compania_nombre;
    $descripcionpagina = "Terminos y Condiciones - $compania_nombre. Observa para que tengas muy detallado nuestros Términos y Condiciones que tenemos en nuestra plataforma.";
...
$arrresultado = $conexion->doSelect("
    ...
    ",
    "seccion_activo = '1' and seccion.seccion_id = '$Seccion_Terminos' and seccion.cuenta_id = '$SistemaCuentaId' and seccion.compania_id = '$SistemaCompaniaId' ");
foreach($arrresultado as $i=>$valor){
