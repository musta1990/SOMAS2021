...
$UrlFiles = UrlFiles;
$Seccion_QuienesSomos = Seccion_QuienesSomos;
...
foreach($arrresultado as $i=>$valor){
    ...
    $titulopagina = "Quienes Somos - ".$compania_nombre;
    $descripcionpagina = "Quienes Somos - $compania_nombre. Vinculamos personas con profesionales para que puedan resolver tu solicitud cerca de tu ubicación. ";
...
$arrresultado = $conexion->doSelect("
    ...
    ",
    "seccion_activo = '1' and seccion.seccion_id = '$Seccion_QuienesSomos' and seccion.cuenta_id = '$SistemaCuentaId' and seccion.compania_id = '$SistemaCompaniaId' ");
foreach($arrresultado as $i=>$valor){
    ...
    $urlseccionimg = $UrlFiles."admin/arch/$seccion_img";     
}
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <center>
                        <div class="about-img">
                            <!-- <img src="<?php echo $urlseccionimg;?>" class="img-fluid w-100 rounded" alt="<?php echo $compania_nombre;?>" class="img-responsive"> -->
                        </div>
                    </center>
                </div>
