...
(isset($_GET['lid'])) ? $getformapago_id=$_GET['lid'] :$getformapago_id='';
(isset($_GET['fid'])) ? $getformapagolistacuenta_id=$_GET['fid'] :$getformapagolistacuenta_id='';
...
foreach($arrresultado as $i=>$valor){
    ...
    $titulopagina = "Pagar Plan - ".$compania_nombre;
    $descripcionpagina = "Pagar Plan - $compania_nombre. Paga tu Plan y comienza a disfrutar del plan consiguiendo clientes cerca de ti. Recibe mas propuestas";
...
$arrresultado = $conexion->doSelect("
  ...
  moneda.lista_nombredos as moneda_siglas, listaplanservicio.l_moneda_id
...
$arrresultado = $conexion->doSelect("
    ...
    ",
    "lista.lista_activo = '1' and listaformapago.cuenta_id = '$SistemaCuentaId' and listaformapago.compania_id = '$SistemaCompaniaId' and lista.tipolista_id = '21' and lista.lista_id = '$getformapago_id' and listacuenta.listacuenta_id = '$getformapagolistacuenta_id'  and ((lista.lista_ppal = '1' $wherelistaactivo) or (lista.lista_ppal = '0' ))  ", null, "lista.lista_orden asc");
...
if ($listaformapago_banco!=""){$agregar .=" <strong>Banco: </strong>$listaformapago_banco<br /> ";}
if ($listaformapago_titular!=""){$agregar .=" <strong>Titular: </strong>$listaformapago_titular<br /> ";}
if ($listaformapago_documento!=""){$agregar .=" <strong>Nro Documento: </strong>$listaformapago_documento<br /> ";}
if ($listaformapago_tipocuenta!=""){$agregar .=" <strong>Tipo Cuenta: </strong>$listaformapago_tipocuenta<br /> ";}
if ($listaformapago_nrocuenta!=""){$agregar .=" <strong>Nro Cuenta: </strong>$listaformapago_nrocuenta<br /> ";}
if ($listaformapago_email!=""){$agregar .=" <strong>Email: </strong>$listaformapago_email<br /> ";}
if ($listaformapago_otros!=""){$agregar .=" <strong>Otros: </strong>$listaformapago_otros<br /> ";}

$textoformapago = $agregar;
...
<section class="section">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h3>Plan para Adquirir: <span style="font-weight: normal;"> <?php echo $plan_nombre;?></span></h3>
                <h4>Precio para Pagar: <span style="font-weight: normal;"> <?php echo $preciomostrar;?></span></h4>
                <h4>Forma de Pago:  <span style="font-weight: normal;"> <?php echo $lista_nombre; ?></span></h4>
                <hr />
            </div>
        </div>

        <div class="row" id="formapago_1">
            <div class="col-md-4">
                <h3><?php echo $lista_nombre; ?>
                    <br>
                    <img src="<?php echo $urlimgFormaPago;?>" style="height: 80px">
                  
                   </h3>              
                <br />
                <?php echo $textoformapago; ?>                
            </div>
            <div class="col-md-5">
                <h3>Anexo Comprobante de Pago</h3>
                <br />
                <form method="post" action="uploadpago" target="iframeupload" enctype="multipart/form-data">
                    <div class="row">                        
                        <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-md-10" style="margin-top: 15px">
                            <label for="plan_id" style="font-size: 16px">Anexar Comprobante: <span style="color: red"></span></label>
                            <br />                            
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label for="referencia">Monto Pagado (Puntos para decimales) <span style="color: red">*</span></label>
                                    <input type="text" class="form-control" id="monto" name="monto" placeholder="0.00" required="required">
                                </div>
                                <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="input-group date">                                        
                                        <input type="text" class="form-control pull-right datepicker" id="fechapago" name="fechapago" placeholder="dd/mm/aaaa" required="required">
                                    </div>
                                </div>
                                <div class="form-group col-md-12">
                        ...
                        <div class="col-md-12" style="margin-top: 15px">
                            <input type="submit" name="button"  value="Guardar Pago" class="btn btn-primary">
                        </div>
                    </div>
                    <input type="hidden" id="formpago" name="formpago" value="<?php echo $lista_id; ?>">
                    <input type="hidden" id="formpagocuenta" name="formpagocuenta" value="<?php echo $listacuenta_id; ?>">
                    <input type="hidden" name="plan_id" value="<?php echo $plan_id; ?>">
                    <input type="hidden" name="moneda_id" value="<?php echo $l_moneda_id; ?>">
