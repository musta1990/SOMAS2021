...
session_start();
$getreferido = $_COOKIE["getreferido"];


$displayreferido = " style = 'display: none' ";
if ($getreferido!=""){
    $displayreferido = "";
}
...
foreach($arrresultado as $i=>$valor){
    ...
    $titulopagina = "Registrarse como Prestador de Servicio - ".$compania_nombre;
    $descripcionpagina = "Registrarse como Prestador de Servicio - $compania_nombre ";
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 offset-md-2 text-center">
            <!-- Title text -->
            <h3>Registrarse como Prestador de Servicio</h3>
          </div>
        </div>
      </div>
      <!-- Container End -->
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-8 align-item-center">
                <div class="border">
                    <h3 class="bg-gray p-4"  style="text-align: center">Registro como Prestador</h3>
                    <form action="javascript:registrarusuarioprestador()" >
                        <fieldset class="p-4">
                            <div <?php echo $displayreferido;?> >
                                Referido por: <?php echo $getreferido;?>
                            </div>
                            ...
                            <a class="mt-3 d-block  text-primary" href="iniciar-sesion">Ya tienes cuenta? Ingresa aquí</a>                            
                        </fieldset>

                        <input type="hidden" id="ubic" name="ubic" value="<?php echo $getinfo;?>">
                        <input type="hidden" id="plan" name="plan" value="<?php echo $getplanid;?>">
                        <input type="hidden" id="formapago" name="formapago" value="<?php echo $getformapago;?>">
                    </form>
                </div>
            </div>
        </div>
