...
foreach($arrresultado as $i=>$valor){
    ...
    $titulopagina = "Prestadores Notificados - ".$compania_nombre;
    $descripcionpagina = "Prestadores Notificados - $compania_nombre ";
...
$arrresultado = $conexion->doSelect("
  ...
  solicitudserv_codigo, solicitudserv_codigoint, solicitudservicio.l_estatus_id as estatus_idsolicitudservicio, 
  ...
  ",
  "solicitudserv_activo = '1' and solicitudservicio.usuario_id = '$iniuser' and solicitudservicio.solicitudserv_id = '$getsolicitudserv_id'  and solicitudservicio.cuenta_id = '$SistemaCuentaId' and solicitudservicio.compania_id = '$SistemaCompaniaId'  ", null, "solicitudservicio.solicitudserv_id desc"); 
...
foreach($arrresultado as $i=>$valor){
  ...
  $usuarioprestador = "<a href='prestador?id=$usuarioprestador_id&sid=$solicitudserv_id' style='color: #0B787A'>
      <img src='arch/$usuarioprestador_img' style='height: 30px; radius: 50%' title='Perfil $usuarioprestador' />
      $usuarioprestador (Ver Perfil)
   </a>";
   ...
   if ($estatusservicioprestador_cod=="4" ){ // Contratado
     $chatcliente = "
        <a href='panel-chat?id=$solicitudservpresta_id'>
          <img src='images/chat.png' alt='Chat' style='height: 50px' title='Chatear' />
        </a>

    ";  
    
      $btncalificar = "&nbsp
      <a href='panel-calificar?id=$usuarioprestador_id&sid=$solicitudserv_id' class='btn btn-main-sm' style='color: #FFF; background: #E78E08; font-size: 14px; margin-top: 10px'>
  ...
  if ($estatusservicioprestador_cod =="3"){ // Contactado
    ...
    ";  
      $btncontratar = "&nbsp
      <a href='panel-contratar?id=$usuarioprestador_id&sid=$solicitudserv_id' class='btn btn-main-sm' style='color: #FFF; font-size: 14px; margin-top: 10px'>
  ...
  if ($estatusservicioprestador_cod =="5"){ // Calificado
  ...
  $textosolicitudes .= "
    <tr style='font-size: 14px; text-align: center'>
        ...
        <td>$solicitudservpresta_fechareg</td>                    
        <td>
          $estatusservicioprestador_nombre $chatcliente<br>
            ...
            <div class="row">
                ...
                <div class="col-md-10 offset-md-1 col-lg-9 offset-lg-0 order-sm-2 order-1">
                    ...
                    <div class="widget welcome-message" style="padding-bottom: 10px">
                        <h2 style="font-size: 24px"><i class="fa fa-paper-plane"></i> Prestadores Notificados </h2>
                        <hr>
                        <h2 style="font-size: 20px">Solicitud #<?php echo $solicitudserv_codigo;?>: <?php echo $solicitudserv_titulo;?></h2>
                        <h2 style="font-size: 20px"></h2>
                        <p>Puedes observar todas las notificaciones que fueron enviadas de su solicitud</p>
