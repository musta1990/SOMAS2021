...
foreach($arrresultado as $i=>$valor){
    ...
    $titulopagina = "Mi Perfil como Prestador de Servicio - ".$compania_nombre;
    $descripcionpagina = "Mi Perfil como Prestador de Servicio - $compania_nombre ";
...
$arrresultado = $conexion->doSelect("usuario.usuario_id, usuario_codigo, usuario_email, usuario_nombre, usuario_apellido,
    ...
    ",
    "usuario_eliminado = '0' and usuario.usuario_id = '$_COOKIE[iniuser]'  and usuario.cuenta_id = '$SistemaCuentaId' and usuario.compania_id = '$SistemaCompaniaId' ");
foreach($arrresultado as $i=>$valor){
            ...
            <div class="row">
                ...
                <div class="col-md-10 offset-md-1 col-lg-9 offset-lg-0 order-sm-2 order-1">
                    ...
                    <div class="widget welcome-message" style="padding-bottom: 10px">
                        <h2>
                            <i class="fa fa-user"></i> Mi Perfil como Prestador de Servicio 
                            <a href="prestador?id=<?php echo $usuario_id;?>" target="_blank" style="font-size: 16px; color: #328D9C">
                                (Ver Perfil Público)
                            </a>
                        </h2>
                        <p>Manten actualizado tu perfil para poder comunicarnos de forma rapida para su solicitud</p>
                    </div>
                    <!-- Edit Personal Info -->
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="widget personal-info">
                                ...
                                <form method="post" action="uploadperfilprestador" target="iframeupload" enctype="multipart/form-data">            
