...
foreach($arrresultado as $i=>$valor){
    ...
    $titulopagina = "Agregar Servicio - ".$compania_nombre;
    $descripcionpagina = "Agregar Servicio - $compania_nombre ";
...
//$optioncategoria = ObtenerLista('41', $SistemaCuentaId, $SistemaCompaniaId, $l_tipousuarioserv_id); 
            ...
            <div class="row">
                ...
                <div class="col-md-10 offset-md-1 col-lg-9 offset-lg-0 order-sm-2 order-1">
                    ...
                    <div class="widget welcome-message" style="padding-bottom: 10px">
                        <h2><i class="fa fa-plus-circle"></i> Agregar Servicio</h2>
                        <p>Puedes seleccionar el servicio que deseas agregar y seleccionar los servicios que ofreces</p>
                    </div>
                    <!-- Edit Personal Info -->
                    <div class="row">
                        <div class="col-lg-12">
